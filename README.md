...
| **Languages** | Python, Mel, etc.|
| **Frontend** | HMTL 5, CSS,  |
| **Backend** | Java |
| **Currently Learning** | Lua, etc.|
...
<!-- 
WORKING ON TO ADD SOON
### Let's Collaborate!
-->

<!--
**Toribioexe/Toribioexe** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
